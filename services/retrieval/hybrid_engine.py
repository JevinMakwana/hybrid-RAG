...
class HybridQueryEngine:
    ...
    def query(self, user_query):
        ...
        print(f"\n[DEBUG] Processed Query Text: '{query_text}'")
        print(f"[DEBUG] Extracted Entities: {query_entities}")
        ...
        print(f"[DEBUG] Vector Store returned: {len(vector_chunks)} chunks")
        print(f"[DEBUG] Graph Retriever returned: {len(graph_chunks)} chunks")
        ...
        if not context.strip():
            print("[DEBUG] WARNING: Context window is completely empty!")
